...
const assetItemSchema = new mongoose.Schema({
  ...
  identifiers: {
    ...
    apartment: { type: String, index: true },
    block: { type: String, index: true },
    kiosk: { type: String, index: true },
    shipNumber: { type: String, index: true },
    serialNumber: { type: String, index: true },
    ownerName: { type: String, index: true },
    debtorName: { type: String, index: true },
    bankName: { type: String, index: true },
    bankBranch: { type: String, index: true },
    stockAmount: { type: String, index: true },
    certificateEntryNumber: { type: String, index: true },
