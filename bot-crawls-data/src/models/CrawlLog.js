...
const crawlLogSchema = new mongoose.Schema({
  type: { type: String, enum: ['auction_notice', 'org_selection', 'detail', 'org_detail', 'duplicate_scan', 'organizer_duplicate_scan', 'recrawl_missing_properties', 'mega_detail_crawl', 'crawl_duplicate_details', 'fix_missing_data'], required: true },
