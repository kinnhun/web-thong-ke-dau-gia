const { extractPropertyIdentifiers, hasConflictingIdentifiers, hasMatchingStrongIdentifiers } = require('../bot-crawls-data/src/utils/helpers.js');
...
const t2 = t1; // 382830 is identical to 310238
...
const id1 = extractPropertyIdentifiers(t1);
const id3 = extractPropertyIdentifiers(t3);

console.log('ID1:', id1);
console.log('ID3:', id3);
console.log('Match Strong:', hasMatchingStrongIdentifiers(id1, id3));
console.log('Conflict:', hasConflictingIdentifiers(id1, id3));
